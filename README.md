...
The overview of TCRBagger architecture and workflow of training and validation are described below:  
![image](https://user-images.githubusercontent.com/89248357/135286739-2bda8165-ea5b-48c5-afdd-f8879035381c.png)
## Requirements  
#### python modules:  
* python == 3.6.2  
* numpy == 1.18.5  
